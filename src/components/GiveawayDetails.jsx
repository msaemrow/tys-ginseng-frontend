  ...
  return (
    <div className="giveaway-container">
      ...
      <div className="giveaway-body">
        <p>
          Every $70 purchased gets you automatically entered for a
          chance to win 2 Savannah Bananas baseball tickets. The more you spend, the more entries you get! The game is on Aug
          8th at Target Field in Minneapolis. Don't miss out on this exciting
          opportunity to enjoy a fun day of baseball with the Savannah Bananas!
        </p>
        ...
        <p className="giveaway-terms">
          ...
          more automatically enters you into the giveaway. Every $70 purchasd gets one entry. Example $70 = 1 entry, $140 = 2 enties, $210 = 3 entries, etc. Purchase can be made online or in person at the
